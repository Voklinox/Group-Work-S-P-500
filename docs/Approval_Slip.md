...
| **Nominal Variable (2–5 categories)** | `Sector` — exactly **5 consolidated categories**:<br>1. *Industrials & Energy* ($n=148$, $29.4\%$, Mode)<br>2. *Consumer* ($n=116$, $23.1\%$)<br>3. *Tech & Comms* ($n=108$, $21.5\%$)<br>4. *Finance* ($n=71$, $14.1\%$)<br>5. *Healthcare* ($n=60$, $11.9\%$) | ✅ **YES** |
